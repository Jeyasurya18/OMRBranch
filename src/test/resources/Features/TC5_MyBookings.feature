@Cancel
Feature: Verifying OMR Branch Cancelbooking Automation

  Background: 
    Given User is on OMR Branch hotel page

  Scenario Outline: Cancel the orderId
    ...
    Then User should verify the success message after cancel orderId "Your booking cancelled successfully"
